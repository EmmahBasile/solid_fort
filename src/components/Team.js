            ...
            <dh-component>
                <div className="container flex justify-center mx-auto pt-16">
                    <div>
                        ...
                        <h1 className="xl:text-4xl text-3xl text-center text-red-800 font-extrabold pb-6 sm:w-4/6 w-5/6 mx-auto">The Talented People Behind the Scenes of Solid Ford</h1>
                    </div>
                </div>
